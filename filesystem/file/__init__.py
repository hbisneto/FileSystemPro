...
def compare(file1, file2):
    ...
    while file_1_line != '' or file_2_line != '': 
        ...
        if file_1_line != file_2_line: 
            ...
            if file_1_line == '': 
                ...
                # difference_lines.append("@", "Line-%d" % line_no, file_1_line)
                difference_lines.append(f'@ Line {line_no} {file_1_line}')
            else: 
                # print("@-", "Line-%d" % line_no, file_1_line)
                # difference_lines.append("@-", "Line-%d" % line_no, file_1_line)
                difference_lines.append(f'@- Line {line_no} {file_1_line}')
            ...
            if file_2_line == '': 
                ...
                # difference_lines.append("#", "Line-%d" % line_no, file_2_line)
                difference_lines.append(f'# Line {line_no} {file_2_line}')
            else: 
                # print("#+", "Line-%d" % line_no, file_2_line)
                # difference_lines.append("#+", "Line-%d" % line_no, file_2_line)
                difference_lines.append(f'#+ Line {line_no} {file_2_line}')
    ...
    file_2.close()
    # print(common_lines)
    # print(difference_lines)
    
    return common_lines, difference_lines
